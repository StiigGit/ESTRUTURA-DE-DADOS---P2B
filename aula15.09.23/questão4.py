# 4. Crie uma função que recebe um vetor de números inteiros e retorna o segundo
# menor número.  Certifique-se de que sua função funcione mesmo se houver números duplicados no vetor.
